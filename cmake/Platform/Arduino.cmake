...
function(get_arduino_flags COMPILE_FLAGS_VAR LINK_FLAGS_VAR BOARD_ID MANUAL)
    ...
    if (BOARD_CORE)
        ...
        # output
        set(COMPILE_FLAGS " -g -Os -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics ")
...
function(setup_arduino_library VAR_NAME BOARD_ID LIB_PATH COMPILE_FLAGS LINK_FLAGS)
    ...
    if (NOT TARGET ${TARGET_LIB_NAME})
        ...
        find_sources(LIB_SRCS ${LIB_PATH}/src ${${LIB_SHORT_NAME}_RECURSE})
        if (LIB_SRCS)
